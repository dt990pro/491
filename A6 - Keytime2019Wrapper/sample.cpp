...
const char *WINDOWTITLE = { "project #6 -- Jiawei Mo" };
...
InitGraphics( void )
{
	...
	Xpos.AddTimeValue(2.f, 100.f);
	Xpos.AddTimeValue(4.f, 800.f);
	Xpos.AddTimeValue(6.f, 500.f);
	Xpos.AddTimeValue(8.f, 600.f);
	Xpos.AddTimeValue(9.f, 1200.f);
	Xpos.AddTimeValue(   10.f,  0.f );
	Ypos.AddTimeValue(    0.f,    0.f );
	Ypos.AddTimeValue(2.f, 100.f);
	Ypos.AddTimeValue(4.f, 500.f);
	Ypos.AddTimeValue(6.f, 1000.f);
	Ypos.AddTimeValue(8.f, 500.f);
	Ypos.AddTimeValue(9.f, 200.f);
	Ypos.AddTimeValue(   10.f,  0.f );
	Zpos.AddTimeValue(    0.f,    0.f );
	Zpos.AddTimeValue(2.f, 600.f);
	Zpos.AddTimeValue(4.f, 1200.f);
	Zpos.AddTimeValue(6.f, 400.f);
	Zpos.AddTimeValue(8.f, 600.f);
	...
	Hue.AddTimeValue(0., 0.3);
	Hue.AddTimeValue(2., 0.0);
	Hue.AddTimeValue(4., 0.3);
	Hue.AddTimeValue(6., 0.5);
	Hue.AddTimeValue(8., 0.4);
	Hue.AddTimeValue(9., 0.2);
	Hue.AddTimeValue(10., 0.3);
	V.AddTimeValue(0., 0.2);
	V.AddTimeValue(2., 0.6);
	V.AddTimeValue(4., 0.1);
	V.AddTimeValue(6., 0.3);
	V.AddTimeValue(8., 0.4);
	V.AddTimeValue(9., 0.7);
	V.AddTimeValue(10., 0.2);
}
